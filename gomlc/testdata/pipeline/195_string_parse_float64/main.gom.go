...
func main0() struct{} {
    ...
    var inline22 string = "3.125"
    var inline23 Tuple2_4bool_7float64 = __goml_builtin_string_parse_float64(inline22)
    mtmp0 = inline23
    var x0 bool = mtmp0._0
    var x1 float64 = mtmp0._1
    var t0 string
    var inline21 string = _goml_runtime_core_bool_to_string(x0)
    t0 = inline21
    var inline19 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t0)
    _goml_runtime_core_string_println(inline19)
    var t1 string
    var inline18 string = __goml_builtin_float64_to_string(x1)
    t1 = inline18
    var inline16 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t1)
    _goml_runtime_core_string_println(inline16)
    var mtmp1 Tuple2_4bool_7float64
    var inline14 string = "3.14"
    var inline15 Tuple2_4bool_7float64 = __goml_builtin_string_parse_float32(inline14)
    mtmp1 = inline15
    var x2 bool = mtmp1._0
    var x3 float64 = mtmp1._1
    var t2 string
    var inline13 string = _goml_runtime_core_bool_to_string(x2)
    t2 = inline13
    var inline11 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t2)
    _goml_runtime_core_string_println(inline11)
    var t3 string
    var inline10 string = __goml_builtin_float64_to_string(x3)
    t3 = inline10
    var inline8 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t3)
    _goml_runtime_core_string_println(inline8)
    var mtmp2 Tuple2_4bool_7float64
    var inline6 string = "not-a-number"
    var inline7 Tuple2_4bool_7float64 = __goml_builtin_string_parse_float64(inline6)
    mtmp2 = inline7
    var x4 bool = mtmp2._0
    var x5 float64 = mtmp2._1
    var t4 string
    var inline5 string = _goml_runtime_core_bool_to_string(x4)
    t4 = inline5
    var inline3 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t4)
    _goml_runtime_core_string_println(inline3)
    var t5 string
    var inline2 string = __goml_builtin_float64_to_string(x5)
    t5 = inline2
