...
func summarize(event__0 FloatEvent) string {
    ...
    case Sample32:
        ...
        var t0 string
        var inline0 string = __goml_builtin_float32_to_string(x1)
        t0 = inline0
        var t1 string = x0 + t0
        return t1
    case Sample64:
        ...
        var t2 string
        var inline1 string = __goml_builtin_float64_to_string(x3)
        t2 = inline1
        var t3 string = x2 + t2
        return t3
    default:
...
func main0() struct{} {
    var first_value__0 float32 = 0.5
    var second_value__0 float32 = 2.25
    var third_value__0 float64 = 9.5
    var first__0 FloatEvent = Sample32{
        _0: "f32=",
        _1: first_value__0,
    }
    var second__0 FloatEvent = Sample32{
        _0: "f32_b=",
        _1: second_value__0,
    }
    var t0 string = summarize(first__0)
    var t1 string = summarize(second__0)
    var t2 string = t0 + t1
    var t3 string
    var inline24 string = "f64="
    var inline25 string = _goml_m_trait__impl_i_ToString_i_f64_i_to__string(third_value__0)
    var inline26 string = inline24 + inline25
    t3 = inline26
    var t4 string = t2 + t3
    var t5 string
    var inline13 float32 = 0.75
    var inline14 float64 = 4
    var inline15 float32 = 1
    var inline16 float64 = 5
    var inline17 bool = inline13 < inline15
    var inline18 bool = inline14 < inline16
    var inline19 string = _goml_m_trait__impl_i_ToString_i_bool_i_to__string(inline17)
    var inline20 string = "left<1?=" + inline19
    var inline21 string = inline20 + ",right<5?="
    var inline22 string = _goml_m_trait__impl_i_ToString_i_bool_i_to__string(inline18)
    var inline23 string = inline21 + inline22
    t5 = inline23
    var t6 string = t4 + t5
    var t7 string
    var inline2 float32 = 1.5
    var inline3 float64 = 7.25
    var inline4 float32 = 1
    var inline5 float64 = 5
    var inline6 bool = inline2 < inline4
    var inline7 bool = inline3 < inline5
    var inline8 string = _goml_m_trait__impl_i_ToString_i_bool_i_to__string(inline6)
    var inline9 string = "left<1?=" + inline8
    var inline10 string = inline9 + ",right<5?="
    var inline11 string = _goml_m_trait__impl_i_ToString_i_bool_i_to__string(inline7)
    var inline12 string = inline10 + inline11
    t7 = inline12
    var message__0 string = t6 + t7
