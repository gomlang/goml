...
func main0() struct{} {
    var start32__0 float32 = 1.25
    var end32__0 float32 = 5.75
    var half__0 float32 = 0.5
    var scale__0 float32 = 2
    var mid32__0 float32
    var inline34 float32 = end32__0 - start32__0
    var inline35 float32 = inline34 * half__0
    var inline36 float32 = start32__0 + inline35
    mid32__0 = inline36
    var neg_end32__0 float32 = -end32__0
    var ratio32__0 float32 = end32__0 / scale__0
    var less32__0 bool = start32__0 < end32__0
    var dx__0 float64 = 6.5
    var dy__0 float64 = 3.5
    var quarter__0 float64 = 0.25
    var energy__0 float64
    var inline30 float64 = dx__0 * dx__0
    var inline31 float64 = dy__0 * dy__0
    var inline32 float64 = inline30 + inline31
    var inline33 float64 = inline32 / 2
    energy__0 = inline33
    var neg_dx__0 float64 = -dx__0
    var t0 float64 = energy__0 + dy__0
    var t1 float64 = dx__0 * quarter__0
    var adjusted__0 float64 = t0 - t1
    var threshold__0 float64 = 4
    var less64__0 bool = adjusted__0 < threshold__0
    var inline26 string = "mid32="
    var inline27 string = _goml_m_trait__impl_i_ToString_i_f32_i_to__string(mid32__0)
    var inline28 string = inline26 + inline27
    println__T_string(inline28)
    var inline22 string = "neg_end32="
    var inline23 string = _goml_m_trait__impl_i_ToString_i_f32_i_to__string(neg_end32__0)
    var inline24 string = inline22 + inline23
    println__T_string(inline24)
    var inline18 string = "ratio32="
    var inline19 string = _goml_m_trait__impl_i_ToString_i_f32_i_to__string(ratio32__0)
    var inline20 string = inline18 + inline19
    println__T_string(inline20)
    var t2 string
    var inline17 string = _goml_runtime_core_bool_to_string(less32__0)
    t2 = inline17
    var t3 string = "less32=" + t2
    var inline15 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t3)
    _goml_runtime_core_string_println(inline15)
    var inline11 string = "energy="
    var inline12 string = _goml_m_trait__impl_i_ToString_i_f64_i_to__string(energy__0)
    var inline13 string = inline11 + inline12
    println__T_string(inline13)
    var inline7 string = "neg_dx="
    var inline8 string = _goml_m_trait__impl_i_ToString_i_f64_i_to__string(neg_dx__0)
    var inline9 string = inline7 + inline8
    println__T_string(inline9)
    var inline3 string = "adjusted="
    var inline4 string = _goml_m_trait__impl_i_ToString_i_f64_i_to__string(adjusted__0)
    var inline5 string = inline3 + inline4
    println__T_string(inline5)
    var t4 string
    var inline2 string = _goml_runtime_core_bool_to_string(less64__0)
    t4 = inline2
    var t5 string = "less64=" + t4
