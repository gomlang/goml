...
func main0() struct{} {
    ...
    var g__0 uint64 = 7
    var h__0 float32 = 1
    var t0 string = _goml_m_trait__impl_i_ToString_i_u8_i_to__string(a__0)
    println__T_string(t0)
    var t1 string
    var inline28 string = __goml_builtin_int8_to_string(b__0)
    t1 = inline28
    var inline26 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t1)
    _goml_runtime_core_string_println(inline26)
    var t2 string
    var inline25 string = __goml_builtin_int16_to_string(c__0)
    t2 = inline25
    var inline23 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t2)
    _goml_runtime_core_string_println(inline23)
    var t3 string
    var inline22 string = __goml_builtin_uint16_to_string(d__0)
    t3 = inline22
    var inline20 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t3)
    _goml_runtime_core_string_println(inline20)
    var t4 string
    var inline19 string = __goml_builtin_uint32_to_string(e__0)
    t4 = inline19
    var inline17 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t4)
    _goml_runtime_core_string_println(inline17)
    var t5 string
    var inline16 string = __goml_builtin_int64_to_string(f__0)
    t5 = inline16
    var inline14 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t5)
    _goml_runtime_core_string_println(inline14)
    var t6 string
    var inline13 string = __goml_builtin_uint64_to_string(g__0)
    t6 = inline13
    var inline11 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t6)
    _goml_runtime_core_string_println(inline11)
    var t7 string
    var inline10 string = __goml_builtin_float32_to_string(h__0)
    t7 = inline10
    var inline8 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t7)
    _goml_runtime_core_string_println(inline8)
    var t8 uint8
    var inline7 uint8 = 10
    t8 = inline7
    var t9 string
    var inline6 string = __goml_builtin_uint8_to_string(t8)
    t9 = inline6
    var inline4 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t9)
    _goml_runtime_core_string_println(inline4)
    var t10 float32
    var inline3 float32 = 2.5
    t10 = inline3
    var t11 string
    var inline2 string = __goml_builtin_float32_to_string(t10)
    t11 = inline2
