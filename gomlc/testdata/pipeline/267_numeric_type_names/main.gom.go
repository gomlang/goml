...
func main0() struct{} {
    ...
    var large__0 float64 = 2.25
    var value__0 uint8 = 65
    var t0 int
    var inline29 int8 = -1
    var inline30 int16 = 2
    var inline31 int32 = 3
    var inline32 int64 = 4
    var inline33 int = 5
    var inline34 int = int(int8(inline29))
    var inline35 int = int(int16(inline30))
    var inline36 int = inline34 + inline35
    var inline37 int = int(int32(inline31))
    var inline38 int = inline36 + inline37
    var inline39 int = int(int64(inline32))
    var inline40 int = inline38 + inline39
    var inline41 int = inline40 + inline33
    t0 = inline41
    var inline27 string = _goml_m_trait__impl_i_ToString_i_isize_i_to__string(t0)
    _goml_runtime_core_string_println(inline27)
    var t1 uint
    var inline14 uint8 = 1
    var inline15 uint16 = 2
    var inline16 uint32 = 3
    var inline17 uint64 = 4
    var inline18 uint = 5
    var inline19 uint = uint(uint8(inline14))
    var inline20 uint = uint(uint16(inline15))
    var inline21 uint = inline19 + inline20
    var inline22 uint = uint(uint32(inline16))
    var inline23 uint = inline21 + inline22
    var inline24 uint = uint(uint64(inline17))
    var inline25 uint = inline23 + inline24
    var inline26 uint = inline25 + inline18
    t1 = inline26
    var inline12 string = _goml_m_trait__impl_i_ToString_i_usize_i_to__string(t1)
    ...
    t4 = inline10
    var t5 string = t3 + t4
    var inline8 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t5)
    _goml_runtime_core_string_println(inline8)
    var t6 uint16 = uint16(uint8(value__0))
    var inline6 string = _goml_m_trait__impl_i_ToString_i_u16_i_to__string(t6)
    _goml_runtime_core_string_println(inline6)
    var t7 Option__char
    var inline4 uint32 = 65
    var inline5 Option__char = __goml_builtin_char_from_uint32(inline4)
    t7 = inline5
    var t8 rune
    var inline2 rune = 63
    ...
    var inline0 string = _goml_m_trait__impl_i_ToString_i_char_i_to__string(t8)
...
func _goml_m_trait__impl_i_ToString_i_u16_i_to__string(self__0 uint16) string {
    var inline0 uint64 = uint64(uint16(self__0))
    var inline1 string = decimal_string(inline0)
    return inline1
}
