...
| llvm | JIT execution, debug metadata, globals/named structs, vectors/atomics, exception handling, linkage/attributes and explicit ABI-name selection; LLVM 18 target machines now provide cross-target configuration, ABI layouts, target-aware passes and file/memory emission |
