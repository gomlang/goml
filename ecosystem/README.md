...
| [request](request/README.md) | HTTP(S)/HTTP2 clients, request builders, JSON/form/multipart, redirects, cancellation, TLS policy, immutable body snapshots and bounded responses | Implemented; 11 library tests and race checks, 4 native race tests, consumer and Python HTTP interoperability pass |
