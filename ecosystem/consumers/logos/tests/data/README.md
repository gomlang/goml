...
Source: Python re full-match evaluation of every candidate input prefix, including exhaustive short binary strings and explicit priority ties.

Seed: `20260921`. The input and expected values were extracted once from
`ecosystem/logos/interop.py` at repository commit
